...
namespace benchmark_redis_scan
{
    interface Cache {
        ...
        **/
        public static long GenerateCache(Cache cache, int population = 256, int vertical = 6, string content = "") {
            ...
            var timeElasped = Misc.measure(() => _GenerateCache(cache, horizontal, vertical, content));
